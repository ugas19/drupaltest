...
use Drupal\cdp_entity_test\Event\TestEvent;
...
class UserLoginSubscriber implements EventSubscriberInterface {
  ...
  public static function getSubscribedEvents() {
    return [
      ...
      TestEvent::TESTAS => 'dumpas',
    ];
  }

  public function dumpas() {
    var_dump("EVENT DISPATCHED");
  }
  /**
